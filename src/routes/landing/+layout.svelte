<script lang="ts">
    ...
    import MobNav from '$lib/Land/MobNavLand.svelte';
import '../../app.postcss';
...
<button
    class="btn btn-sm hidden relative overflow-hidden inline-flex items-center justify-center h-9 px-6 py-0 mx-1
    text-center font-medium tracking-wider uppercase text-sm
    bg-gradient-to-r from-transparent to-transparent
    border-[1.5px] border-gray-600
    rounded-full
