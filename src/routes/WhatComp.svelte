<div id="about" class="relative bg-white rounded-2xl drop-shadow-2xl overflow-hidden my -8 ">
    <div class="max-w-7xl mx-auto">
        <div class="relative z-10 pb-8 bg-wh ite  sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
            <svg class="hidden lg:block absolute right-8 inset-y-0 h-full w-48 text-white transform translate-x-1/2"
            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left text-gray-900">
                    <h2 class="my-6 text-2xl hidden tracking-tight font-extrabold text-gray-900 sm:text-3xl md:text-4xl">
                        About Us
                    </h2>
                    <div class="lg:relative lg:inset-y-0 left-80 lg:w- 1/4">
